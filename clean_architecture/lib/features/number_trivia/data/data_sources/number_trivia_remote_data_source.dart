...
class NumberTriviaRemoteDataSourceImpl implements NumberTriviaRemoteDataSource {
  ...
  @override
  Future<NumberTriviaModel> getConcreteNumberTrivia(int? number) =>_getTrivia('http://numbersapi.com/$number');

  @override
  Future<NumberTriviaModel> getRandomNumberTrivia() => _getTrivia('http://numbersapi.com/random');
